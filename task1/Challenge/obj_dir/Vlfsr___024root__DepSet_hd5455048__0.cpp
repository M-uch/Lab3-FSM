...
VL_INLINE_OPT void Vlfsr___024root___sequent__TOP__1(Vlfsr___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__lfsr__DOT__shiftreg7__DOT__sreg 
        = vlSelf->lfsr__DOT__shiftreg7__DOT__sreg;
    if (vlSelf->rst) {
        vlSelf->__Vdly__lfsr__DOT__shiftreg7__DOT__sreg = 1U;
    } else if (vlSelf->en) {
        vlSelf->__Vdly__lfsr__DOT__shiftreg7__DOT__sreg 
            = ((0x7eU & ((IData)(vlSelf->lfsr__DOT__shiftreg7__DOT__sreg) 
...
VL_INLINE_OPT void Vlfsr___024root___sequent__TOP__2(Vlfsr___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->en) {
        vlSelf->lfsr__DOT__data_in = (1U & VL_REDXOR_8(
                                                       (0x44U 
                                                        & (IData)(vlSelf->lfsr__DOT__shiftreg7__DOT__sreg))));
    }
}
...
VL_INLINE_OPT void Vlfsr___024root___sequent__TOP__3(Vlfsr___024root* vlSelf) {
    ...
    // Body
    vlSelf->lfsr__DOT__shiftreg7__DOT__sreg = vlSelf->__Vdly__lfsr__DOT__shiftreg7__DOT__sreg;
    vlSelf->data_out = vlSelf->lfsr__DOT__shiftreg7__DOT__sreg;
}
