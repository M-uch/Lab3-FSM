...
VL_ATTR_COLD void Vlfsr___024root__trace_init_sub__TOP__0(Vlfsr___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+6,"reg4", false,-1, 4,1);
    tracep->pushNamePrefix("shiftreg4 ");
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBit(c+2,"rst", false,-1);
    tracep->declBit(c+3,"en", false,-1);
    tracep->declBit(c+5,"data_in", false,-1);
    tracep->declBus(c+6,"data_out", false,-1, 4,1);
...
VL_ATTR_COLD void Vlfsr___024root__trace_full_sub_0(Vlfsr___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+6,(vlSelf->lfsr__DOT__shiftreg4__DOT__sreg),4);
}
